...
import { ArrowLeft, MapPin, Calendar, Edit3, Save, Trash2, Image as ImageIcon, Video, X, Eye } from 'lucide-react';
...
const PostDetail = () => {
    ...
    const { visitedPlaces, updatePlaceArticle, removePlace } = useTravel();
            ...
            <div className="relative h-[60vh] w-full overflow-hidden group">
                ...
                {isEditing && (
                    <div className="absolute inset-0 flex items-center justify-center bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity">
                        <label className="cursor-pointer bg-white/20 hover:bg-white/30 text-white px-6 py-3 rounded-full backdrop-blur-md flex items-center gap-2 transition-all">
                            <ImageIcon size={20} /> Change Cover
                ...
                {isEditing ? (
                    <div className="glass-panel p-6 border border-white/10 rounded-xl">
                        ...
                        <div className="flex gap-2 mb-4 border-b border-white/10 pb-4 overflow-x-auto">
                            <label className="p-2 hover:bg-white/10 rounded cursor-pointer text-gray-300" title="Insert Image">
                                <ImageIcon size={20} />
